...
const CommentReply = ({lang, fetchProfileInfo, from_id, commentText, commentDate, likes, isLightTheme, openCommentMenu, commentId, ownerId, navigation, attachments, author, is_deleted, accessToken, type}) => {
